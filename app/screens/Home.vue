        ...
        <GridLayout rows="*" columns="2*, 5*">
            ...
            <ScrollView col="1">
                <GridLayout rows="240, *, *, *, *, *" columns="*" verticalAlignment="center">
                    ...
                    <RadListView ref="listView" for="movie in movies" orientation="horizontal" col="0" row="2">
                        <v-template>
    ...
    export default {
        ...
        methods: {
            ...
            onLoaded(event) {
                ...
                /**
                httpModule.request({
                    url: 'https://service-cloud.digiturkplay.com/api/v2/users/account/login',
                    method: 'POST',
